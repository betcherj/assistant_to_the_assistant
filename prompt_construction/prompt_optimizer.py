        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert at optimizing prompts for LLM models. Your goal is to "
            ...
            if optimized.startswith("```"):
                optimized = optimized.split("```", 2)[-1].rsplit("```", 1)[0].strip()
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert at optimizing prompts based on performance feedback."
                    },
                    {
                        "role": "user",
                        "content": optimization_prompt
