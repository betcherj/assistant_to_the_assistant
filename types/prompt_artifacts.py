...
class SystemIOExample(BaseModel):
    """System-level input/output example."""
    input_description: str = Field(..., description="Description of system input")
    output_description: str = Field(..., description="Description of system output")
...
class FeatureExample(BaseModel):
    ...
    input_description: str = Field(..., description="Description of feature input")
    output_description: str = Field(..., description="Description of feature output")
    example: Optional[str] = Field(None, description="Concrete example if available")
